...
use App\Filament\Resources\EventRegisterResource\Pages;
use App\Filament\Resources\EventRegisterResource\RelationManagers;
...
class EventRegisterResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\ViewEventRegister::route('/{record}'),
